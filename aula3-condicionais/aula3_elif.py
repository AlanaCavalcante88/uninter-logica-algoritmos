#### elif - simplifica o if else quando tem muitos

#### Condições aninhadas com elif
# Escreva um algoritmo em que o usuário escolhe se quer comprar maçãs, 
# laranjas ou bananas. Deverá ser apresentado na tela um menu com as
...
if (produto == 1): # maçã
  ...
  # qualquer coisa que não for as frutas acima
else:
